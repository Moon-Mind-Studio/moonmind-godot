...
{    
	...
	*/
    ...
    ADD_PROPERTY(PropertyInfo(Variant::BOOL, "flippedX"), _SCS("flip_x"), _SCS("is_fliped_x"));
    ADD_PROPERTY(PropertyInfo(Variant::BOOL, "flippedY"), _SCS("flip_y"), _SCS("is_fliped_y"));
